// Questions List
export const medMathQuestions = [
    {
      questionText: 'Find the missing terms in multiple of 3: 3, 6, 9, __, 15? Answer: 12',
      answerOptions: [
    ...
    {
      questionText: '3hrs 40 mins equal ____. Answer: 220mins',
      answerOptions: [
    ...
    {
      questionText: "What's 8 x 2? Answer: 24",
      answerOptions: [
    ...
    {
      questionText: 'A bar of chocolate costs PhP 7 each. How many can you buy for PhP 100? Answer: 14',
      answerOptions: [
    ...
    {
      questionText: "What's 8 x 2? Answer: 16",
      answerOptions: [
    ...
    {
      questionText: 'The smallest single-digit composite number is ____. Answer: 2',
      answerOptions: [
    ...
    {
      questionText: 'A number is multiplied by 8 and divided by 4. The result is 12. What is the number? Answer: 6',
      answerOptions: [
        { symbol: '✌', answerText: '5', isCorrect: false },
