// Questions List
export const medEngQuestions = [
  {
    questionText: 'She _____ your new teacher? Answer: is',
    answerOptions: [
  ...
  {
    questionText: 'What is the plural form a knife? Answer: Knives',
    answerOptions: [
  ...
  {
    questionText: 'What is the past tense of place? Answer: Placed',
    answerOptions: [
  ...
  {
    questionText: "_____ the time? It's 9o'clock Answer: What's",
    answerOptions: [
  ...
  {
    questionText: "I'm looking at that woman, she (wear) a nice dress. Answer: wearing",
    answerOptions: [
  ...
  {
    questionText: 'I _____ my studies by completed Answer: had completed',
    answerOptions: [
  ...
  {
    questionText: '_____ are ten students in my class. Answer: There',
    answerOptions: [
